...
using ControleFuncionariosV2.Buscar;
using ControleFuncionariosV2.Secundarios;
using System;
...
namespace ControleFuncionariosV2.Cadastro
{
    public partial class FrmCadEndereco : Form
    {
        ...
        {
            ClnEnderecosRepository ObjUsuario = new ClnEnderecosRepository();//Criar Obj
        ...
        private void btnSair_Click(object sender, EventArgs e)
        {
            ...
            {
                FrmFuncExcluidos ObjBuscarFuncExcluidos = new FrmFuncExcluidos();
        ...
        private void btnGravar_Click(object sender, EventArgs e)
        {
            ...
            {
                ClnEnderecosRepository ObjClnEndereco = new ClnEnderecosRepository();
                ...
                else if (ObjOperacao == ClnFuncoesGerais.Operacao.Alteracao)//Verifica se é alteração faça
                {
                    ...
                    CarregaDataGrid(); //Chama o Método Preencher a Grid
                    FrmCadEndereco objCadEnderecos = new FrmCadEndereco();
        ...
        {
            FrmCadEndereco ObjCadEndereco = new FrmCadEndereco();
        ...
        private void BtnExcluir_Click(object sender, EventArgs e)
        {
            ...
            {
                ClnEnderecosRepository objUsuario = new ClnEnderecosRepository(); //Apagar da Agenda

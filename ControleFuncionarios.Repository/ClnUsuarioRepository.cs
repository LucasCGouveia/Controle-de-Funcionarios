...
namespace ControleFuncionarios.Repository
{
    public class ClnUsuarioRepository
    {
        ...
        public DataSet ListarUserParaAtribuir(string strDescricao )//Recebe a string do campo descrição, enviado por parâmetro, porém com retorno
        {
            ...
            if (strDescricao != "")
            {
                strQuery = "SELECT U.COD,U.LOGIN from Tb_Usuarios as U INNER JOIN tb_Funcionarios as F on U.COD != F.COD_USUARIO where U.LOGIN like '%" + strDescricao + "%' and U.ATIVO = 1";//String de pesquisa no BD, onde: Seleciona código, nome e telefone pesquisando por qualquer parte do campo nome somente os ativados(não foram excluidos)
            }
            else
            {
                strQuery = "SELECT U.COD,U.LOGIN from Tb_Usuarios as U INNER JOIN tb_Funcionarios as F on U.COD != F.COD_USUARIO where U.ATIVO = 1";//String de pesquisa no BD, onde: Seleciona código, nome e telefone pesquisando por qualquer parte do campo nome somente os ativados(não foram excluidos)
            }
            CldBancoDados ObjBancoDados = new CldBancoDados();//Instancia/cria objeto do BancoDeDados
        ...
        public DataSet ListarUsuariosNaoADM(string strDescricao)//Recebe a string do campo descrição, enviado por parâmetro, porém com retorno
        {
            ...
            if (strDescricao != "")
            {
                strQuery = "SELECT U.COD,U.LOGIN from Tb_Usuarios as U INNER JOIN tb_Funcionarios as F on U.COD = F.COD_USUARIO where U.LOGIN like '%" + strDescricao + "%' and U.TipoUser != 'A' and Login != 'null' and U.ATIVO = 1";//String de pesquisa no BD, onde: Seleciona código, nome e telefone pesquisando por qualquer parte do campo nome somente os ativados(não foram excluidos)
            }
            else
            {
                strQuery = "SELECT U.COD,U.LOGIN from Tb_Usuarios as U INNER JOIN tb_Funcionarios as F on U.COD = F.COD_USUARIO where U.TipoUser != 'A' and Login != 'null' and U.ATIVO = 1";//String de pesquisa no BD, onde: Seleciona código, nome e telefone pesquisando por qualquer parte do campo nome somente os ativados(não foram excluidos)
            }
            CldBancoDados ObjBancoDados = new CldBancoDados();//Instancia/cria objeto do BancoDeDados
            return ObjBancoDados.RetornaDataSet(strQuery);//Envia a consulta por parâmetro para objeto e aguarda o retorno
        }
        ...
        public DataSet ListarUserAtribuidos(string strDescricao)//Recebe a string do campo descrição, enviado por parâmetro, porém com retorno
        {
            ...
            if (strDescricao != "")
            {
                strQuery = "SELECT U.COD,U.LOGIN,F.COD,F.NOME from Tb_Usuarios as U INNER JOIN tb_Funcionarios as F on U.COD = F.COD_USUARIO where U.LOGIN like '%" + strDescricao + "%' and U.ATIVO = 1";//String de pesquisa no BD, onde: Seleciona código, nome e telefone pesquisando por qualquer parte do campo nome somente os ativados(não foram excluidos)
            }
            else
            {
                strQuery = "SELECT U.COD,U.LOGIN,F.COD,F.NOME from Tb_Usuarios as U INNER JOIN tb_Funcionarios as F on U.COD = F.COD_USUARIO where U.ATIVO = 1";//String de pesquisa no BD, onde: Seleciona código, nome e telefone pesquisando por qualquer parte do campo nome somente os ativados(não foram excluidos)
            }
            CldBancoDados ObjBancoDados = new CldBancoDados();//Instancia/cria objeto do BancoDeDados
            return ObjBancoDados.RetornaDataSet(strQuery);//Envia a consulta por parâmetro para objeto e aguarda o retorno
        }
        ...
        public DataSet ListarUsuariosCadUsuario(string strDescricao)//Recebe a string do campo descrição, enviado por parâmetro, porém com retorno
        {
            ...
            if (strDescricao != "")
            {
                strQuery = "SELECT U.COD,U.LOGIN from Tb_Usuarios as U INNER JOIN tb_Funcionarios as F on U.COD != F.COD_USUARIO where U.LOGIN like '%" + strDescricao + "%' and U.TIPOUSER != 'A' U.ATIVO = 1";//String de pesquisa no BD, onde: Seleciona código, nome e telefone pesquisando por qualquer parte do campo nome somente os ativados(não foram excluidos)
            }
            else
            {
                strQuery = "SELECT U.COD,U.LOGIN from Tb_Usuarios as U INNER JOIN tb_Funcionarios as F on U.COD != F.COD_USUARIO where U.TIPOUSER != 'A' and U.ATIVO = 1";//String de pesquisa no BD, onde: Seleciona código, nome e telefone pesquisando por qualquer parte do campo nome somente os ativados(não foram excluidos)
            }
            CldBancoDados ObjBancoDados = new CldBancoDados();//Instancia/cria objeto do BancoDeDados
            return ObjBancoDados.RetornaDataSet(strQuery);//Envia a consulta por parâmetro para objeto e aguarda o retorno
        }
